...
/**
 * This is a mock model class for testing purposes. It returns predictable output so I can test
 * that the controller is running on a basic example of a mondel.
 */
public class MyModel implements MarbleSolitaireModel {
  ...
  public void move(int fromRow, int fromCol, int toRow, int toCol) throws IllegalArgumentException {
    // this function does nothing on purpose, for testing
  }
  ...
  public String getGameState() {
    return "Here is the game state for testing purposes";
  }
